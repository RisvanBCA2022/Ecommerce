...
const Women = () => {
  ...
  const filteredProducts = allproducts.filter((p) => p.type.toLowerCase() === 'women');
          ...
          {filteredProducts.map((product) => (
            <Col xs={12} sm={6} md={4} lg={3} key={product.id}>
              <Card style={{
                ...
                <Card.Img variant="top" src={product.img} style={{ height: '14rem', objectFit: 'cover', borderTopLeftRadius: '10px', borderTopRightRadius: '10px' }} />
                <Card.Body>
                  <Card.Title style={{
                    fontSize: '1.2rem',
                    fontWeight: 'bold',
